  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/50 to-transparent flex flex-col items-center justify-end text-white p-6 text-center">
        ...
        <span className="inline-flex items-center px-4 py-2 border border-white text-sm font-medium rounded-md text-white group-hover:bg-white group-hover:text-gray-900 transition">
          Shop Now
        </span>
      </div>
    </Link>
