            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <span className="ml-3">{location.address}</span>
                </div>
                
                <div className="flex items-center">
                  <Phone className="w-5 h-5 text-primary-600 flex-shrink-0" />
                  <a href={`tel:${location.phone}`} className="ml-3 hover:text-primary-600">
                    {location.phone}
                  </a>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <a href={`mailto:${location.email}`} className="ml-3 hover:text-primary-600">
                    {location.email}
                  </a>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <span className="ml-3">{location.hours}</span>
                </div>
              </div>

              <button className="mt-6 w-full bg-primary-600 text-white py-2 rounded-md hover:bg-primary-700 transition">
                Get Directions
              </button>
            </div>
          </div>
      ...
      <div className="mt-16 bg-primary-50 rounded-lg p-8 text-center">
        ...
        <div className="flex justify-center gap-4">
          ...
          <a
            ...
            className="inline-flex items-center px-6 py-3 border border-primary-600 text-base font-medium rounded-md text-primary-600 hover:bg-primary-50"
          >
