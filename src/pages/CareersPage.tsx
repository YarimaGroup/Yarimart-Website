  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="bg-primary-50 rounded-lg p-8 mb-12">
        <h2 className="text-2xl font-bold mb-6">Why Join Yarimart?</h2>
      ...
      <div className="mt-12 bg-gray-50 rounded-lg p-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <p className="text-gray-600">Apply online with your resume and cover letter</p>
          </div>
          <div className="text-center">
            <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-gray-600">Multiple rounds of interviews with the team</p>
          </div>
          <div className="text-center">
            <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-gray-600">Receive offer and join our team</p>
          </div>
        </div>
      </div>
